...
static int64_t console_read(file_t *f, void *buf, size_t count) {
    ...
    while (read < count) {
        ...
        if (console_buf_start != console_buf_end) {
            c = console_buffer[console_buf_start];
